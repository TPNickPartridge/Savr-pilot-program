...
const WhatIs = () => {
  ...
  return (
    <section id="what-is" className="py-24 md:py-32 bg-secondary/30" ref={ref}>
      <div className="container mx-auto px-6">
        <motion.div
          ...
          <div className="text-center mb-16">
            <h2 className="font-display text-3xl md:text-5xl font-bold mb-6 text-foreground">What is <span className="text-primary">SAVR</span>?</h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed font-light">SAVR helps restaurants fill empty tables with reliable revenue.</p>
          </div>
          ...
          <motion.div
            ...
            <p className="text-lg md:text-xl text-foreground/90 leading-relaxed font-light">SAVR allows restaurants to offer limited off-peak availability to diners who pre-pay for a curated dining experience. Restaurants control the timing, volume, and menu. SAVR simply brings demand to seats that would otherwise go unused.
